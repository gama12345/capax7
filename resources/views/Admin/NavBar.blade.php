...
<html lang="en">
    ...
    <body>
        <div class="navbar">
             <nav>
                <a href="{{ route('home','admin') }}" title="Mis datos"><img class="menuElement" src="/Icons/home-page.png" alt="No se pudo cargar el icono"></img><p>MIS DATOS</p></a>            
                ...
                <a href="{{ route('showStatisticsAdmin') }}" title="Ver estadisticas"><img class="menuElement" src="/Icons/stadistics.png" alt="No se pudo cargar el icono"></img><p>DATOS</p></a>
