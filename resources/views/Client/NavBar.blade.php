...
<html lang="en">
    ...
    <body>
        <div class="navbar">
             <nav>
                <a href="{{ route('home','usuario') }}" title="Inicio"><img class="menuElement" src="/Icons/home-page.png" alt="No se pudo cargar el icono"></img><p>INICIO</p></a>                
                <a href="{{ route('showRegisterDonor') }}" title="Registrar nuevo"><img class="menuElement" src="/Icons/donors.png" alt="No se pudo cargar el icono"></img><p>DONANTE</p></a>
