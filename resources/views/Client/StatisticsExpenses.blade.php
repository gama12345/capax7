...
@section('content')
    <div id="statisticsDonations" class="statisticsDonations">
        <div class="title"><h1>GASTOS</h1></div>
        ...
        <div id="statisticsDonations__fechas">
                ...
                <form method="post" action="{{ route('showDetailedExpensesMonthYear') }}">
                @csrf
            ...
            var chart = new Chart(ctx, {
                ...
                options: {
                    title: {
                        fontSize: 15,
                        display: true,
                        text: "Gastos registrados en "+xAxis[0]+" "+añoSeleccionado
                    },
                    tooltips: {
                        callbacks: {
